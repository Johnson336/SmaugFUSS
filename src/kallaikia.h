...
#define SMAUG_VERSION_MINOR "9"

/*
 * PHANTASIEN Version
 */

#define SMAUG_VERSION_KALLAIKIA "3"
 ...
 *
 */
#define PLAYER_DIR	"../xogadores/"   /* Player files         */
#define BACKUP_DIR	"../backup/"   /* Backup Player files   */
#define GOD_DIR		"../deuses/"  /* God Info Dir         */
#define BOARD_DIR	"../taboeiros_de_anuncios/"   /* Board data dir    */
#define CLAN_DIR	"../clans/" /* Clan data dir     */
#define GUILD_DIR	"../irmandades/" /* Clan data dir     */
#define COUNCIL_DIR  	"../comarcas/" /* Council data dir    */
#define DEITY_DIR	"../deidades/" /* Deity data dir    */
#define BUILD_DIR       "../construccions/" /* Online building save dir     */
...
#define CLAN_LIST	"clans.lista"  /* List of clans     */
#define COUNCIL_LIST	"comarcas.lista"  /* List of councils     */
#define GUILD_LIST      "irmandades.lista" /* List of guilds               */
#define GOD_LIST	"deuses.lista"  /* List of gods         */
...
#define BOARD_FILE	"taboeiros_de_anuncios.msg"   /* For bulletin boards   */
#define SHUTDOWN_FILE	"../logs/apagado.log" /* For 'shutdown'  */
#define IMM_HOST_FILE   SYSTEM_DIR "inmortaies.datos" /* For stoping hackers */
#define RIPSCREEN_FILE	SYSTEM_DIR "kallaikia_rip.rip"
#define RIPTITLE_FILE	SYSTEM_DIR "kallaikia_title.rip"
#define ANSITITLE_FILE	SYSTEM_DIR "kallaikia_title.ans"
#define ASCTITLE_FILE	SYSTEM_DIR "kallaikia_title.asc"
...
#define FIXED_FILE	SYSTEM_DIR "../logs/arranxado.log"  /* For 'fixed' command */
#define LOG_FILE	SYSTEM_DIR "../logs/kallaikia.log" /* For talking in logged rooms */
#define MOBLOG_FILE	SYSTEM_DIR "../logs/criaturas.log" /* For mplog messages  */
#define WIZLIST_FILE	SYSTEM_DIR "../logs/wiz.log" /* Wizlist       */
#define WHO_FILE	SYSTEM_DIR "../logs/quen.log"  /* Who output file  */
#define WEBWHO_FILE	SYSTEM_DIR "../logs/quenweb.log"  /* WWW Who output file */
#define REQUEST_PIPE	SYSTEM_DIR "../logs/peticions.log"   /* Request FIFO  */
#define SKILL_FILE	SYSTEM_DIR "feitizos.datos" /* Skill table   */
#define LOGIN_MSG	SYSTEM_DIR "inicio.msg" /* List of login msgs      */
#define HERB_FILE	SYSTEM_DIR "herbas.datos"  /* Herb table       */
