...
#define PHANTASIEN_VERSION "3alpha"

/*
 * Stuff for area versions
 */
...
#include "dns.h"
#include "inicio.h"
#include "calendario.h" /* AFKMud Calendar Replacement - Samson */
#include "clima.h"  /* Weather System Replacement - Kayle */
#include "liquidos.h" /* SMAUG Liquidtable Replacement - Nopey */
#ifdef IMC
#include "imc.h"
#endif
 ...
 *
 */
#define PLAYER_DIR	"../jugadores/"   /* Player files         */
#define BACKUP_DIR	"../backup/"   /* Backup Player files   */
#define GOD_DIR		"../dioses/"  /* God Info Dir         */
#define BOARD_DIR	      "../tableros_de_anuncios/"   /* Board data dir    */
#define CLAN_DIR	      "../clanes/" /* Clan data dir     */
#define GUILD_DIR	      "../hermandades/" /* Clan data dir     */
#define COUNCIL_DIR  	"../feudos/" /* Council data dir    */
#define DEITY_DIR	      "../deidades/" /* Deity data dir    */
#define BUILD_DIR       "../construcciones/" /* Online building save dir     */
#define SYSTEM_DIR	"../sistema/"   /* Main system files    */
#define PROG_DIR	      "../mudprogs/" /* MUDProg files     */
#define CORPSE_DIR	"../cadaveres/"  /* Corpses        */
#define CLASS_DIR	      "../clases/"  /* Classes        */
#define RACE_DIR 	      "../razas/" /* Races */
...
#define AREA_LIST	      "zonas.lista"  /* List of areas     */
#define WATCH_LIST      "watch.lista" /* List of watches              */
#define BAN_LIST        "baneados.lista"   /* List of bans                 */
#define RESERVED_LIST	"reservados.lista" /* List of reserved names  */
#define CLAN_LIST	      "clanes.lista"  /* List of clans     */
#define COUNCIL_LIST	"feudos.lista"  /* List of councils     */
#define GUILD_LIST      "hermandades.lista" /* List of guilds               */
#define GOD_LIST	      "dioses.lista"  /* List of gods         */
#define DEITY_LIST	"deidades.lista" /* List of deities      */
#define CLASS_LIST	"clases.lista" /* List of classes      */
#define RACE_LIST	      "razas.lista"  /* List of races     */
#define MORPH_FILE      "polimorfismos.datos" /* For morph data */
#define BOARD_FILE	"tableros_de_anuncios.msg"   /* For bulletin boards   */
#define SHUTDOWN_FILE	"../logs/apagado.log" /* For 'shutdown'  */
#define IMM_HOST_FILE   SYSTEM_DIR "inmortales.datos" /* For stoping hackers */
#define RIPSCREEN_FILE	SYSTEM_DIR "phantasienIIIrip.rip"
#define RIPTITLE_FILE	SYSTEM_DIR "phantasienIIItitle.rip"
#define ANSITITLE_FILE	SYSTEM_DIR "phantasienIIItitle.ans"
#define ASCTITLE_FILE	SYSTEM_DIR "phantasienIIItitle.asc"
#define BOOTLOG_FILE	SYSTEM_DIR "../logs/inicio.log"   /* Boot up error file  */
#define PBUG_FILE	      SYSTEM_DIR "../logs/errores.log"  /* For 'bug' command   */
#define IDEA_FILE	      SYSTEM_DIR "../logs/ideas.log"  /* For 'idea'       */
#define TYPO_FILE	      SYSTEM_DIR "../logs/tipos.log"  /* For 'typo'       */
#define FIXED_FILE	SYSTEM_DIR "../logs/arreglado.log"  /* For 'fixed' command */
#define LOG_FILE	      SYSTEM_DIR "../logs/phantasienIII.log" /* For talking in logged rooms */
#define MOBLOG_FILE	SYSTEM_DIR "../logs/criaturas.log" /* For mplog messages  */
#define WIZLIST_FILE	SYSTEM_DIR "../logs/wiz.log" /* Wizlist       */
#define WHO_FILE	      SYSTEM_DIR "../logs/quien.log"  /* Who output file  */
#define WEBWHO_FILE	SYSTEM_DIR "../logs/quienweb.log"  /* WWW Who output file */
#define REQUEST_PIPE	SYSTEM_DIR "../logs/peticiones.log"   /* Request FIFO  */
#define SKILL_FILE	SYSTEM_DIR "hechizos.datos" /* Skill table   */
#define LOGIN_MSG	"inicio.msg" /* List of login msgs      */
#define HERB_FILE	      SYSTEM_DIR "hierbas.datos"  /* Herb table       */
#define TONGUE_FILE	SYSTEM_DIR "idiomas.datos"   /* Tongue tables    */
#define SOCIAL_FILE	SYSTEM_DIR "social.datos"   /* Socials       */
#define COMMAND_FILE	SYSTEM_DIR "comandos.datos"  /* Commands      */
#define PROJECTS_FILE	SYSTEM_DIR "../logs/projects.log"  /* For projects  */
#define PLANE_FILE	SYSTEM_DIR "planos.datos" /* For planes       */
