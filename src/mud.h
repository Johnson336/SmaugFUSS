...
#define BACKUP_DIR	RUNDIR	"backup/"   /* Backup Player files 	*/
...
#define RETIREDLIST_FILE 	SYSTEM_DIR "retiredlist.dat"	
...
#define CHARCOUNT_FILE	LOGDIR 	    "ccount.log"	  /* Counting, temp */
