...
void boot_db( bool fCopyOver )
{
   ...
   if( !sysdata.dlHandle )
   {
      log_string( "Enlazador dinamico: Error abrindo o executable, revisa os FLAGS utilizados no Makefile." );
      shutdown_mud( "fallo en libdl" );
      exit( 1 );
   }
   ...
   log_string( "Cargando Funcions Especiais ..." );
   load_specfuns(  );

   log_string( "Cargando configuracion do sistema ..." );
   ...
   {
      log_string( "Non encontrado.  Creando nova configuracion." );
   ...
   log_string( "Cargando habilidades sociais ... " );
   load_socials(  );

   log_string( "Cargando tabla de feitizos e habilidades ... " );
   load_skill_table(  );
   sort_skill_table(  );
   ...
   log_string( "Cargando datos de novas" );
   load_news(  );
    ...
    */
   log_string( "Inicializando xerador de numeros aleatorios ..." );
   init_mm(  );
    ...
    */
   {
      ...
      log_string( "Establecendo data e climatoloxia." );

      if( !load_timedata(  ) )   /* Loads time from stored file if TRUE - Samson 1-21-99 */
      {
         boot_log( "Restaurando a data basandose na actual do sistema." );
   ...
   log_string( "Cargando taboa de vacacions ..." ); /* Samson 5-13-99 */
   load_holidays(  );
...
#ifdef PLANES
   log_string( "Analizando ficheiro con datos de planos ..." );
   load_planes(  );
#endif
    ...
    */
   {
      ...
      log_string( "Analizando ficheiros con datos de zonas do reino ..." );
      if( !( fpList = fopen( AREA_LIST, "r" ) ) )
      {
         perror( AREA_LIST );
         shutdown_mud( "ERROR! Non se puede abrir zonas.lista" );
         exit( 1 );
      }
      ...
      for( ;; )
      {
         if( feof( fpList ) )
         {
            bug( "%s: EOF encontrado analizando %s non se atopou $ ao final do ficheiro.", __FUNCTION__, AREA_LIST );
            break;
         }
...
#ifdef PLANES
   log_string( "Comprobando que se xenerou o plano das habitacions ..." );
   check_planes( NULL );
#endif
   ...
   log_string( "Establecendo saidas" );
   fix_exits(  );
   fBootDb = FALSE;
   ...
   if( fCopyOver )
   {
      log_string( "Cargando o estado de mundo ..." );
      load_world(  );
   }
   ...
   log_string( "Cargando taboeiros de anuncios ... " );
   load_boards(  );

   log_string( "Cargando clans" );
   load_clans(  );

   log_string( "Cargando comarcas" );
   load_councils(  );
   ...
   log_string( "Cargando servidores Inmortais ..." );
   load_imm_host(  );
    ...
    */
   log_string( "Cargando polimorfismos/mutacions" );
   load_morphs(  );
   MOBtrigger = TRUE;
