 ...
 * \_____  \\_ |__   ______ ____  __ _________|__|/  |_|__| ____   ______   *
 *  /   |   \| __ \ /  ___// ___\|  |  \_  __ \  \   __\  |/ __ \ /  ___/   *
 * /    |    \ \_\ \\___ \\  \___|  |  /|  | \/  ||  | |  \  ___/ \___ \    *
 * \_______  /___  /____  >\___  >____/ |__|  |__||__| |__|\___  >____  >   *
 *         \/    \/     \/     \/                              \/     \/    *
 *                       A SMAUG Derivative.                                *
 * ------------------------------------------------------------------------ *
 * Obscurities 1.0.0 Copyright 1999-2007 by Steven Loar                     *
...
//Weather version of URANGE
#define WRANGE(a, b, c)		((b) < (a) ? (a) : ((b) > (c) ? (c) : (b)))

// File that stores Weather Information 
#define WEATHER_FILE "mapaclima.datos"
